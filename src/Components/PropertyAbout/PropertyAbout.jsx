    ...
    <div className={style.container}>
      <div className={style.aboutText}>
        ...
        <p>
          ...
          leasing options to suit the needs of tenants. The property management
          services ensure efficient operations, maintenance, and tenant
          satisfaction, thereby maximizing the value of the properties under
          their care.
        </p>
      </div>
